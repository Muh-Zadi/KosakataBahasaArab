...
//handle error saat tidak terkoneksi ke internet
    ...
    class PrefechData extends AsyncTask<Void, Void, Void> {
        ...
        public PrefechData(){
            progress.setTitle(Kosakata_Binatang.this.getString(R.string.app_name));
        ...
        protected void onPostExecute(Void result) {
            if(progress.isShowing()){
                progress.dismiss();
                imgs.setImageResource(R.mipmap.babi_awal);
                txtIndo.setText("Babi");
                txtArab.setText("خِنْزِيْرٌ");
