...
public class MainActivity_Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__buah);
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MainActivity_Quiz.this);
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            Glide.with(getApplicationContext())
                    .load("http://192.168.43.228/kosakata/images/" + listSoal.get(urutan_soal_soal).getGambar())
                    .crossFade()
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            if ((rb1.isChecked() == false) && (rb2.isChecked() == false) && (rb3.isChecked() == false) && (rb4.isChecked() == false)) {
                ...
                tampilKotakAlert = new AlertDialog.Builder(MainActivity_Quiz.this)
                        .create();
