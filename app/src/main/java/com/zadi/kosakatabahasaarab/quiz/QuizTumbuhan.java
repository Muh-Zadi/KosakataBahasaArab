...
public class QuizTumbuhan extends AppCompatActivity {
    ...
    private class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(QuizTumbuhan.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String jsonStr = sh.makeServiceCall(Config.url_soal_tumbuhan, ServiceHandler.GET);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            if ((rb1.isChecked() == false) && (rb2.isChecked() == false) && (rb3.isChecked() == false) && (rb4.isChecked() == false)) {
                ...
                tampilKotakAlert = new AlertDialog.Builder(QuizTumbuhan.this).create();
