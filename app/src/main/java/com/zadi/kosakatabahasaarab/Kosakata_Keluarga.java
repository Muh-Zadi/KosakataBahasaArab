...
//handle error saat tidak terkoneksi ke internet
        ...
        stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>(){
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Kosakata_Keluarga.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    class PrefechData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            if(progress.isShowing()){
                progress.dismiss();
                imgs.setImageResource(R.mipmap.ayah_awal);
                txtIndo.setText("Ayah");
                txtArab.setText("اَبٌ");
