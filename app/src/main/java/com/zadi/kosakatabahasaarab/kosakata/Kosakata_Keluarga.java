...
public class Kosakata_Keluarga extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(Kosakata_Keluarga.this);
...
//handle error saat tidak terkoneksi ke internet
        ...
        stringRequest = new StringRequest(Request.Method.GET, Config.url_keluarga, new Response.Listener<String>(){
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++){
                        ...
                        AdapterList_Keluarga adapter =  new AdapterList_Keluarga(Kosakata_Keluarga.this, list_data, imgs,txtIndo,txtArab);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Kosakata_Keluarga.this, "Tidak dapat menemukan server, mohon periksa ulang koneksi internet anda", Toast.LENGTH_LONG).show();
                finish();
            }
        });
    ...
    class PrefechData extends AsyncTask<Void, Void, Void> {
        ProgressDialog progress = new ProgressDialog(Kosakata_Keluarga.this);

        public PrefechData(){
            progress.setTitle(Kosakata_Keluarga.this.getString(R.string.app_name));
        ...
        protected Void doInBackground(Void... params) {
            Log.d("JSON", JSONTools.getJSON(Config.url_keluarga).toString());
            return null;
        }
    ...
    private void playsound(){
        ...
        mp3=MediaPlayer.create(this, R.raw.ayah);
