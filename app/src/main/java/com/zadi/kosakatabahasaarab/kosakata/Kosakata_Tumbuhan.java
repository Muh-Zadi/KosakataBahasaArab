...
public class Kosakata_Tumbuhan extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(Kosakata_Tumbuhan.this);
        ...
        stringRequest = new StringRequest(Request.Method.GET, Config.url_tumbuhan, new Response.Listener<String>(){
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Kosakata_Tumbuhan.this, "Tidak dapat menemukan server, mohon periksa ulang koneksi internet anda", Toast.LENGTH_LONG).show();
                finish();
            }
        });
    ...
    class PrefechData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            Log.d("JSON", JSONTools.getJSON(Config.url_tumbuhan).toString());
            return null;
        }
