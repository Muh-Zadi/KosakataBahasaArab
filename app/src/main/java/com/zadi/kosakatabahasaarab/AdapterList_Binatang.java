...
public class AdapterList_Binatang extends RecyclerView.Adapter<AdapterList_Binatang.ViewHolder> {
    Context context;
    ImageView imgViewOne;
    private TextView txtIndo, txtArab;
    private MediaPlayer mp3;
    ArrayList<HashMap<String, String >> list_data;
    public AdapterList_Binatang(Kosakata_Binatang mainActivity, ArrayList<HashMap<String, String >>list_data, ImageView imgs, TextView txtindo, TextView txtarab){
    ...
    @Override
    public AdapterList_Binatang.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_images, null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterList_Binatang.ViewHolder holder, final int position) {
